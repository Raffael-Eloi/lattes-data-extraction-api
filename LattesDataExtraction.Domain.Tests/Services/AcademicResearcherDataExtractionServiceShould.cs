    ...
    internal class AcademicResearcherDataExtractionServiceShould
    {
        ...
        public void Extract_Completed_Orientation_Information_From_File()
        {
            ...
            Assert.Multiple(() =>
            {
                ...
                Assert.That(academicResearcher.CompletedOrientation.First().KeyWords.ToList(), Has.Count.GreaterThanOrEqualTo(3));
        ...
        public void Extract_Participation_In_Final_Paper_Panel_Information_From_File()
        {
            ...
            Assert.That(academicResearcher.ParticipationInFinalPaperPanel.ToList(), Has.Count.GreaterThanOrEqualTo(62));
